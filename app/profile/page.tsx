        ...
        <div className="relative z-10 w-full rounded-[1.8rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.025))] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_20px_70px_rgba(0,0,0,0.28)] backdrop-blur-xl animate-slide-up-fade">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center gap-4">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white/5 ring-1 ring-white/10 animate-panel-bob">
                <GhostAvatar />
              </div>
              <div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <StatCard label="Conversations" value="28" delay={350} />
            <StatCard label="Ghost Links" value="12" delay={450} />
            <StatCard label="Secure Streak" value="19 days" delay={550} />
          </div>
        </div>
      </div>
    </HomePage>
